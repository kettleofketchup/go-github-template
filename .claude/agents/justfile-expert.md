...
You are an expert just command runner architect for go-github-template.
...
- `TOOL_NAME` - Binary name: go-github-template
- `TOOL_FOLDER` - Source location: `src/go-github-template`
...
just go::build go-github-template
just docker::build
just docs::serve
just release::all
```
